(function () {
    'use strict';
    angular.module('root').controller('CordovaDeviceOrientationCtrl', ['toastr','$ionicPlatform','$cordovaVibration', 'DSCacheFactory', CordovaDeviceOrientationCtrl]);
    function CordovaDeviceOrientationCtrl(toastr, $ionicPlatform, $cordovaVibration, DSCacheFactory) {
        
		self.globalSettingCache = DSCacheFactory.get("globalSettingCache");

        var vm = this;
		
        vm.title = "Cordova :: deviceOrientation.html"; vm.result = "No input";
