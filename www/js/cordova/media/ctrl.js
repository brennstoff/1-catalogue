(function () {
    'use strict';
    angular.module('root').controller('CordovaMediaCtrl', ['toastr','$ionicPlatform', 'DSCacheFactory', CordovaMediaCtrl]);
    function CordovaMediaCtrl(toastr, $ionicPlatform, $cordovaVibration, DSCacheFactory) {
        
		self.globalSettingCache = DSCacheFactory.get("globalSettingCache");

        var vm = this;
		
        vm.title = "Cordova :: media.html"; vm.result = "No input";
