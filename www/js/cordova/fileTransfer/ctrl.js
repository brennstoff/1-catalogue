(function () {
    'use strict';
    angular.module('root').controller('CordovaFileTransferCtrl', ['toastr','$ionicPlatform','$cordovaVibration', 'DSCacheFactory', CordovaFileTransferCtrl]);
    function CordovaFileTransferCtrl(toastr, $ionicPlatform, $cordovaVibration, DSCacheFactory) {
        
		self.globalSettingCache = DSCacheFactory.get("globalSettingCache");

        var vm = this;
		
        vm.title = "Cordova :: fileTransfer.html"; vm.result = "No input";
