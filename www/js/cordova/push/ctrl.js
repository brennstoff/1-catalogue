(function () {
    'use strict';
    angular.module('root').controller('CordovaPushCtrl', ['toastr','$ionicPlatform', 'DSCacheFactory', CordovaPushCtrl]);
    function CordovaPushCtrl(toastr, $ionicPlatform, $cordovaVibration, DSCacheFactory) {
        
		self.globalSettingCache = DSCacheFactory.get("globalSettingCache");

        var vm = this;
		
        vm.title = "Cordova :: push.html"; vm.result = "No input";
