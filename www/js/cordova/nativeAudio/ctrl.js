(function () {
    'use strict';
    angular.module('root').controller('CordovaNativeAudioCtrl', ['toastr','$ionicPlatform', 'DSCacheFactory', CordovaNativeAudioCtrl]);
    function CordovaNativeAudioCtrl(toastr, $ionicPlatform, $cordovaVibration, DSCacheFactory) {
        
		self.globalSettingCache = DSCacheFactory.get("globalSettingCache");

        var vm = this;
		
        vm.title = "Cordova :: nativeAudio.html"; vm.result = "No input";
