(function () {
    'use strict';
    angular.module('root').controller('CordovaLocalNotificationCtrl', ['toastr','$ionicPlatform','$cordovaVibration', 'DSCacheFactory', CordovaLocalNotificationCtrl]);
    function CordovaLocalNotificationCtrl(toastr, $ionicPlatform, $cordovaVibration, DSCacheFactory) {
        
		self.globalSettingCache = DSCacheFactory.get("globalSettingCache");

        var vm = this;
		
        vm.title = "Cordova :: localNotification.html"; vm.result = "No input";
