(function () {
    'use strict';
    angular.module('root').controller('CordovaImagePickerCtrl', ['toastr','$ionicPlatform','$cordovaVibration', 'DSCacheFactory', CordovaImagePickerCtrl]);
    function CordovaImagePickerCtrl(toastr, $ionicPlatform, $cordovaVibration, DSCacheFactory) {
        
		self.globalSettingCache = DSCacheFactory.get("globalSettingCache");

        var vm = this;
		
        vm.title = "Cordova :: imagePicker.html"; vm.result = "No input";
